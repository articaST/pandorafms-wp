...
class PFMS_GoogleAnalytics {
	...
	public function show_google_analytics () {
		...
		$varialbe = get_option($pfms_wp->prefix . 'ga_google_token');
		...
		<div class="wrap">
		  ...
		  <div  id="key">
			...
			<form method="post" action="options.php">
			  <?php settings_fields('pfmswp-options-ga'); ?>
			  <input type="text" name="pfmswp-options[PMFS_ga_google_token]" value="" style="width:450px;"/>
			  <input type="submit" name="submit" id="submit" value="Save &amp; Continue" />
			</form>
		  </div>
		  <br />
		  <hr />
		  ...
		  <form method="post" action="options.php">
			<input type="text" name="pfmswp-options[PMFS_ga_google_uid_token_uid]" value="" style="width:450px;"/>
			<input type="submit"  name="submit" id="submit" value="Save &amp; Continue" />
		  </form>
		</div>
		<?php
