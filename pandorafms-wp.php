...
//register_uninstall_hook(__FILE__, array('PandoraFMS_WP', 'uninstall'));//This method is not necesary because exists the uninstall.php file
...
add_action('wp_ajax_send_test_email', array('PandoraFMS_WP', 'ajax_send_test_email'));
//=== END ==== AJAX HOOKS ==============================================
